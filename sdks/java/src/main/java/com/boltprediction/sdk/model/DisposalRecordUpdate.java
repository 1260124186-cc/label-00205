...
public class DisposalRecordUpdate {

    @JsonProperty("disposal_type")
    private Object disposalType;
    ...
    public Object getDisposalType() {
        return disposalType;
    }

    public void setDisposalType(Object disposalType) {
    ...
    public void setDisposalContent(Object disposalContent) {
